...
public class Clase5_2 {
    ...
    { 
            ...
            while (true) {
                ...
                try {
                    input = JOptionPane.showInputDialog("Enter any valid Integer: ");
                    // Parsing user input to integer
                    // using the parseInt() method
                    number = Integer.parseInt(input);
                    JOptionPane.showMessageDialog(null, "You Enter Numbre" +  number, "Resultado" , JOptionPane.WARNING_MESSAGE);
